...
books = [
    ...
    {
        'Название': 'Философия Java. 4-е полное изд. | Эккель Брюс',
...
#  Cоздадим два списка: один с названиями книг, другой с их описаниями
name_book = df_books['Название'].tolist()
description_book = df_books['Описание'].tolist()

tfidf_matrix = tfidf.fit_transform(description_book)
